##  Specious Sites
GitHub repository for websites utilized to document the popularity and influence of different unreliable news websites. This dataset consists of 1404 unreliable news websites. This GitHub repository will be updated with the code and weights of the model utilized in our paper.
...
If our lists of sites are useful for your own research, you can cite us with the following BibTex entry:
    ...
    @article{hanley2023specious,
        ...
        journal={arXiv preprint arXiv:2308.02068},
        year={2023}
    }
